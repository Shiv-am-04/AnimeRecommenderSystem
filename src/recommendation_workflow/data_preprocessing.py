...
class DataProcessor:
    ...
    def encode_data(self):
        try:
            ...
            logging.info("Encoding done for Users and Anime")
        except Exception as e:
            raise CustomException(e,sys)
    
    def split_data(self, test_size=0.3 , random_state=43):
        try:
            ...
            logging.info("Data splitted sucesfullyy")
    ...
    def save_artifacts(self):
        try:
            ...
            logging.info("All the training testing data as well as rating_df is saved now..")
        except Exception as e:
            raise CustomException(e,sys)
    ...
    def process_anime_data(self):
        try:
            ...
            logging.info("DF AND SYNOPSIS_Df saved sucesfullyy...")
    ...
    def run(self):
        try:
            ...
            logging.info("Data Processing Pipeline Run sucesfully .... Congrats")
